# Propiedad intelectual del entregable
...
Podes:
- Publicarlo en tu GitHub publico
- Compartirlo en redes
- Incluirlo en tu portfolio
- Usarlo como base de un producto propio

### 2. Que pasa si no te contratamos

Si tras la evaluacion completa (Parte A + B + Apendice + Parte C) Loggro decide no avanzar contigo, **no usamos comercialmente tu entrega**. La info se queda dentro del equipo evaluador para los fines descritos en `consentimiento_grabacion.md` y se elimina segun los terminos de retencion.
...
Si despues del reto Loggro identifica que un componente especifico de tu entregable (un agente, un eval, una libreria, un MCP server, lo que sea) seria valioso licenciar pero **no te contratamos para el puesto**, te buscamos para una **conversacion separada con compensacion** justa de mercado. Cero presion: podes decir que no.
...
Los datasets sinteticos que viven en `data/` (cuentas, campanas, briefs, audios, transcripts, etc.) son **propiedad de Loggro**. Tu uso permitido es:

- Construir tu entregable del reto y evaluarlo
- Documentar tu pipeline con ejemplos del dataset

Tu uso **NO permitido**:

- Republicar los datasets como dataset propio
- Vender los datasets a terceros
- Usar los datasets para entrenar modelos para terceros

Los audios MP3 del Track D son grabaciones generadas con TTS (o reales anonimizadas) propiedad de Loggro.

## 7. Firma del candidato

```
He leido y acepto los terminos de propiedad intelectual descritos arriba.
